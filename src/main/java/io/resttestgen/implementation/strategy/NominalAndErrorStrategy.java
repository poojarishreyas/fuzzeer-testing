...
import io.resttestgen.implementation.fuzzer.AdaptiveErrorFuzzer;
import io.resttestgen.implementation.fuzzer.BreachingFuzzer;
...
public class NominalAndErrorStrategy extends Strategy {
    ...
    private static final int BREACH_BUDGET = 30;
    ...
    public void start() {
        ...
        executeBreachingFuzzer(testSequencesToReport);
    ...
    private void executeErrorFuzzer(List<TestSequence> testSequencesToReport) {
        AdaptiveErrorFuzzer errorFuzzer = new AdaptiveErrorFuzzer(globalNominalTestSequence);
    ...
    private void executeBreachingFuzzer(List<TestSequence> testSequencesToReport) {
        BreachingFuzzer breachingFuzzer = new BreachingFuzzer(globalNominalTestSequence);
        List<TestSequence> breachingSequences = breachingFuzzer.generateTestSequences(BREACH_BUDGET);
        testSequencesToReport.addAll(breachingSequences);
    }
